                                ...
                                <ul class="login">
                                    {{-- <li>
                                        <div class="cart-option">
                                            <a href="{{ route('register') }}" class="fa fa-shopping-cart">Register</a>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="cart-option">
                                            <a href="{{ route('login') }}" class="fa fa-shopping-cart">Login</a>
                                        </div>
                                    </li> --}}
                                    <li>
                                        <div class="cart-option">
                                            <a href="{{ route('posts.create') }}" class="fa fa-shopping-cart">NEW
                                                POST</a>
                                        </div>
                                    </li>
                                </ul>
                        ...
                        <div class="full">
                            <div class="footer-widget">
                                ...
                                <ul class="social-icons style-4 pull-left">
                                    ...
                                    <li><a class="twitter" href="#"><i class="fa fa-twitter"></i></a></li>
                                    <li><a class="youtube" href="#"><i class="fa fa-youtube-play"></i></a></li>
                                    <li><a class="pinterest" href="#"><i class="fa fa-pinterest-p"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="full">
                            <div class="footer-widget">
                                ...
                                <ul class="address-list">
                                    <li><i class="fa fa-map-marker"></i> Lorem Ipsum is simply dummy text of the
                                        printing..
                                    </li>
                                    <li><i class="fa fa-phone"></i> 123 456 7890</li>
                                    <li><i style="font-size:20px;top:5px;" class="fa fa-envelope"></i> demo@gmail.com
                                    </li>
                                </ul>
                            </div>
                        </div>
